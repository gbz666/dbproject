...
- 你收集到足够的信息，能够回答用户的最终问题时，你必须在`Action:`字段后使用 `Finish[最终答案]` 来输出最终答案.
...
if __name__ == '__main__':
    ...
    tool_executor.registerTool("Calculator", "一个计算器。当你需要计算数学表达式时，应使用此工具。", calculator)
    agent = ReActAgent(llm_client=llm, tool_executor=tool_executor)
    question = "计算（8892989382*82181）+291192-19291/100"
    agent.run(question)
